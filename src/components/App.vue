<template>
    <div class="page-main">
        <div class="bg-content">
            ...
            <div class="fish-list">
                ...
                <transition-group tag="div" v-bind:css="false" v-on:enter="enter">
                    <p v-for="(item, index) in fishList" v-bind:key="index" :data-direct="item.direct"
                ...
                <transition-group tag="div" v-bind:css="false" v-on:enter="lottery" v-on:after-enter="afterLottery">
                    <p v-for="(item, index) in lotteryFishList" v-bind:key="index" :data-type="item.type"
                        :data-direct="item.direct" :data-index="index" :data-money="item.money" :data-name="item.name">
        ...
        <div class="bottom-nav">
            ...
            <a href="javascript:;" class="butn-chugan" @click="chugan"> <span class="icon-bg"><i
                        class="js-chugan-process"></i></span><img :src="chuganTxt"> </a>
...
export default {
    ...
    methods: {
        allImgLoaded() {
            console.log(`all img loaded: isDev`, isDev)
            // 待加载资源
            ...
            for (var i = 0; i < allNeededImgArray.length; i++) {
                var _img = new Image();
                if (isDev) {
                    _img.src = allNeededImgArray[i].replace('/hldy', '');
                } else {
